...
import com.nt.comp.ButterSctchIcecream;
...
public class DecoratorTest2 {
	...
	public static void main(String[] args) {
		Icecream ice1= new ButterSctchIcecream();
		ice1.prepare();
		System.out.println("-----------------------------------");
		Icecream ice2=new DryFruitsDecorator(new ButterSctchIcecream( ));
		ice2.prepare();
		Icecream ice3=new DryFruitsDecorator(new HoneyDecorator(new ButterSctchIcecream()));
		ice3.prepare();
